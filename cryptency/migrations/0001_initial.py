    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user_email', models.CharField(max_length=50, verbose_name='E-mail')),
                ('service_name', models.CharField(blank=True, max_length=100, verbose_name='Название сервиса')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user_withdraw_date', models.DateTimeField(auto_now_add=True, null=True, verbose_name='Дата заявки')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('service_pk_id', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='cryptency.services', verbose_name='ID сервиса')),
            ],
            options={
                'verbose_name': 'Видео',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user_birthday', models.DateField(blank=True, null=True, verbose_name='Дата рождения')),
                ('user_email', models.CharField(max_length=50, unique=True, verbose_name='E-mail')),
                ('user_password', models.CharField(max_length=50, verbose_name='Пароль')),
                ('user_photo', models.ImageField(blank=True, null=True, upload_to='users_avatar/', verbose_name='Аватарка')),
                ...
                ('user_service_id', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='cryptency.services')),
            ],
            options={
